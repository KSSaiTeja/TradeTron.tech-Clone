  ...
  try {
    new ((function () {
      function t() {
        ...
        try {
          (this.ns = "CrispLoader"),
            ...
            this.Sp(),
            !0 === window[this.wp] ||
              (void 0 !== window[this._p] &&
                "function" == typeof window[this._p].__init) ||
              !0 !== this.Pp() ||
              ((window[this.wp] = !0),
      ...
      return (
              ...
              (function t() {
                s.Tp = setTimeout(function () {
                  (s.Tp = null),
                    (s.Np -= s.mp),
                    void 0 !== window[s._p] &&
                    "function" == typeof window[s._p].__init &&
                    !0 === n()
                      ? (s.n.info(
        ...
        (i.bp = function () {
          try {
            this.Fp("dns-prefetch", this.$s),
              this.Fp("preconnect", this.io),
              this.Xp(),
              this.zp();
          } catch (t) {}
        }),
        ...
        (i.Hp = function () {
          (this.Op = !1),
            (this.Tp = null),
            (this.Np = this.Ip),
            (this.kp = document.domain),
            (this.jp = document.location.href),
            (this.Bp = document.location.hostname),
            (this.Gp = window.navigator.userAgent),
            (this.xp = new Date().getTimezoneOffset()),
            (this.Lp = this.Qp()),
            "string" == typeof CRISP_WEBSITE_ID && CRISP_WEBSITE_ID
              ? (this.Dp = CRISP_WEBSITE_ID)
              : (this.Dp = this.Vp()),
            ...
            "string" == typeof CRISP_COOKIE_DOMAIN && CRISP_COOKIE_DOMAIN
              ? (this.Ap = CRISP_COOKIE_DOMAIN)
              : (this.Ap = null),
            "function" == typeof CRISP_READY_TRIGGER
              ? (this.Mp = CRISP_READY_TRIGGER)
              : (this.Mp = {}),
            "object" == typeof CRISP_RUNTIME_CONFIG
              ? (this.Yp = CRISP_RUNTIME_CONFIG)
              : (this.Yp = {}),
            "object" == typeof CRISP_INCLUDE_ATTRS
              ? (this.Zp = CRISP_INCLUDE_ATTRS)
              : (this.Zp = {});
        }),
        (i.$p = function () {
          try {
            (this.Up = []),
              "function" == typeof window.MutationObserver &&
                ...
                this.Up.push("browsing"),
              (("function" == typeof window.RTCPeerConnection &&
                "object" == typeof navigator.mediaDevices &&
                "https:" === document.location.protocol &&
                (window.innerWidth || 0) >= this.Cp &&
                (window.innerHeight || 0) >= this.gp) ||
                !0 === this.s) &&
                this.Up.push("call");
          } catch (t) {}
        }),
          ...
          try {
            this.Yp.locale &&
              (-1 !== (t = this.Lp.indexOf(this.Yp.locale)) &&
                this.Lp.splice(t, 1),
              this.Lp.unshift(this.Yp.locale));
          } catch (t) {}
        }),
        (i.Jp = function (t) {
          try {
            for (var i in this.Zp)
              this.Zp.hasOwnProperty(i) && t.setAttribute(i, this.Zp[i]);
          } catch (t) {}
        }),
        (i.Vp = function () {
          var t = null;
        ...
        (i.Pp = function () {
          var t = !0;
          try {
            ((window.innerWidth && window.innerWidth < this.vp) ||
              !0 !== this.t_() ||
              !0 === this.i_(this.Bp) ||
              !0 === this.n_(this.Gp) ||
              !window.WebSocket ||
